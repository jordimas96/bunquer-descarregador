...
Aquest projecte és independent i **no està afiliat a 3Cat ni a Catalunya Ràdio**. L'objectiu és facilitar l'accés a continguts públics del programa **“El Búnquer”**, allotjats a [3cat.cat](https://www.3cat.cat/3cat/el-bunquer). Aquesta web **NO** allotja cap arxiu.
...
Els enllaços de descàrrega provenen directament del lloc oficial i aquesta web **no respon** en cas de problemes amb els fitxers o el servei del lloc oficial.
...
- [Readme](https://bunquer-descarregador.github.io/README)
